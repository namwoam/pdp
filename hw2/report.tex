...
At 64 processes, throughput increases with larger scenes: 1.54 million circles per second for \texttt{imbalance\_c100000}, 2.22 million circles per second for \texttt{medium\_c200000}, 6.54 million circles per second for \texttt{large\_c1000000}, 7.94 million circles per second for \texttt{large\_c2000000}, and 8.99 million circles per second for \texttt{large\_c4000000}.
...
The renderer logs per-rank render time statistics and reports imbalance as \(\max / \mathrm{mean}\). The measured imbalance values are recorded in plotted in Figure ~\ref{fig:imbalance}.
