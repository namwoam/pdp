...
Experiments were conducted on an NVIDIA Tesla V100-SXM2-32GB (sm\_70, 15.7 TFLOPS FP32 peak, 6 MB L2).
The harness benchmarks square matrices $M = N = K \in \{128, 256, 512, 1024, 2048, 4096\}$,
timing 50 iterations with \texttt{cudaEvent} after one warm-up run.
...
\midrule
Naive (global memory only)                    &  2,026 & 14.5\% \\
+ Shared-memory tiling                        &  4,109 & 29.4\% \\
+ 1-D block tiling (register accumulators)    &  7,985 & 57.1\% \\
+ 2-D block tiling (TM$\times$TN per thread)  & 11,195 & 80.0\% \\
+ Vectorized \texttt{float4} loads/stores     & 11,038 & 78.9\% \\
+ Warp tiling (2$\times$2 warp grid, WNITER)  & 12,159 & 86.9\% \\
